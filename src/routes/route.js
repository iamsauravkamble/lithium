...
const middleware = require("../middlewares/newmiddleware")
...
router.post("/createUser",  middleware.userMiddleware, UserController.createUser) 

router.post("/createOrder", middleware.orderMiddleware, OrderController.createOrder)
